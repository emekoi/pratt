...
typedef enum {
  /* general */
  TOK_EOF = 0, TOK_ERROR, TOK_COMMENT, TOK_STRING, TOK_NUMBER, TOK_INDENTIFIER,
  ...
  TOK_OP_AND, TOK_OP_OR, TOK_OP_GREATER, TOK_OP_GREATER_EQUAL, TOK_OP_LESS,
  TOK_OP_LESS_EQUAL, TOK_OP_EQUAL, TOK_OP_NOT_EQUAL,

  TOK_OP_SHIFT_LEFT, TOK_OP_SHIFT_RIGHT, TOK_OP_BIT_OR, TOK_OP_BIT_AND, TOK_OP_XOR,

  TOK_OP_TERNARY, TOK_OP_IS, TOK_OP_RANGE_INCLUDED, TOK_OP_RANGE_EXCLUDED, TOK_OP_ASSIGN,
  ...
  TOK_OP_BIT_OR_ASSIGN, TOK_OP_BIT_AND_ASSIGN, TOK_OP_XOR_ASSIGN,
