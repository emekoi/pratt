...
typedef enum {
  ...
  TOK_KEY_REPEAT, TOK_KEY_DO, TOK_KEY_END,

  /* operators */
  TOK_OP_ADD, TOK_OP_SUB, TOK_OP_MUL, TOK_OP_DIV, TOK_OP_MOD,
  TOK_OP_AND, TOK_OP_OR, TOK_OP_NOT, TOK_OP_GREATER, TOK_OP_GREATER_EQUAL,
  ...
  TOK_OP_TERNARY, TOK_OP_RANGE_INCLUDED, TOK_OP_RANGE_EXCLUDED, TOK_OP_ASSIGN,
